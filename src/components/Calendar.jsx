            ...
            <div className="container mx-auto mt-10 h-auto">
                <div className="wrapper bg-white rounded shadow w-full ">
                    ...
                    <table className="w-full">
                        <thead>
                            <tr>
                                <th className="p-2 border-r h-5 xl:w-5 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
                        ...
                        <tbody>
                            <tr className="text-center h-10">
                                <td className="border p-1 h-20 xl:w-5 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300 ">
                                    <div className="flex flex-col h-20 mx-auto xl:w-5 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                ...
                                <td className="border p-1 h-20 xl:w-5 lg:w-30 md:w-30 sm:w-20 w-10 overflow-hidden transition cursor-pointer duration-500 ease hover:bg-gray-300">
                                    <div className="flex flex-col h-20 mx-auto xl:w-5 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                        <div className="top h-5 w-full">
                            ...
                            <tr className="text-center h-10">
                                ...
                                <td className="border bg-gray-100 p-1 h-20 xl:w-5 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300">
                                    <div className="flex flex-col h-20 mx-auto xl:w-5 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                                        <div className="top h-5 w-full">
                                            <span className="text-gray-500">1</span>
                                        </div>
